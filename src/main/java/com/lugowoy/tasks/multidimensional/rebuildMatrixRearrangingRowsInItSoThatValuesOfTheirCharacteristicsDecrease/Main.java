package com.lugowoy.tasks.multidimensional.rebuildMatrixRearrangingRowsInItSoThatValuesOfTheirCharacteristicsDecrease;
...
public class Main {
    ...
    private static void rebuildMatrixBySortingRowsDescendingCharacteristics(Matrix<Integer> matrix) {
